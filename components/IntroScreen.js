  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] min-h-full flex flex-col items-center
        ...
        <div className="mt-12 grid sm:grid-cols-2 gap-10 sm:gap-0 w-full">
          <div className="intro-stagger sm:pr-10 sm:border-r sm:border-slate-700/60" style={{ '--intro-i': 1 }}>
            ...
            <p className="text-slate-200 text-base sm:text-lg leading-relaxed text-pretty">
              Innovar constantemente, ofreciendo al mercado soluciones integrales
              tanto en hardware como en software para la seguridad, el control
              operativo y la logística de empresas, organismos públicos y
          ...
          <div className="intro-stagger sm:pl-10" style={{ '--intro-i': 2 }}>
            ...
            <p className="text-slate-200 text-base sm:text-lg leading-relaxed text-pretty">
              Consolidar a nuestra empresa a nivel latinoamericano como un socio
              estratégico de nuestros clientes, valorados y reconocidos por la
              eficiencia, nuestra capacidad de innovación y un servicio de nivel
              mundial.
            </p>
          </div>
        </div>
        ...
        {/* Llamado a la acción */}
        <div className="intro-stagger mt-14 text-center" style={{ '--intro-i': 3 }}>
        ...
        <button
          onClick={entrar}
          className="intro-stagger chip-glow group mt-8 flex items-center gap-4
        ...
        {/* Pie institucional */}
        <p className="intro-stagger mt-14 text-xs text-slate-500" style={{ '--intro-i': 5 }}>
