...
const FILAS_DEVENGADO = [
  ...
  { label: '  Abonos',                   get: (d) => d.facturacionMix?.abonos },
  { label: '  Instalaciones',            get: (d) => d.facturacionMix?.instalaciones },
  { label: '  Otros',                    get: (d) => d.facturacionMix?.otros },
  { label: '  Proyectos',                get: (d) => d.facturacionMix?.proyectos },
