...
function parseAndExtractXLSX(arrayBuffer, customVariables = []) {
  ...
  const data = {
    ...
    activoNoCorriente: { total: empty(), participacionOrbitrixArg: empty(), participacionOrbitrixCL: empty(),
                         participacionTricom: empty(), reservasWaraChile: empty(), vehiculos: empty(),
                         mueblesUtiles: empty(), equiposComodato: empty(), stockActual: empty(), sociosAdelantos: empty() },
  ...
  const global = {
    ...
    'participación en orbitrix arg':  { key: 'activoNoCorriente.participacionOrbitrixArg', ip: false },
    'orbitrix arg':                   { key: 'activoNoCorriente.participacionOrbitrixArg', ip: false },
    'participación en orbitrix cl':   { key: 'activoNoCorriente.participacionOrbitrixCL',  ip: false },
    'orbitrix cl':                    { key: 'activoNoCorriente.participacionOrbitrixCL',  ip: false },
    'participación en tricom':        { key: 'activoNoCorriente.participacionTricom',       ip: false },
    'tricom':                         { key: 'activoNoCorriente.participacionTricom',       ip: false },
    'reservas wara chile':            { key: 'activoNoCorriente.reservasWaraChile',         ip: false },
    'vehiculos':                      { key: 'activoNoCorriente.vehiculos',                 ip: false },
    'muebles':                        { key: 'activoNoCorriente.mueblesUtiles',             ip: false },
    'comodato':                       { key: 'activoNoCorriente.equiposComodato',           ip: false },
    'stock actual':                   { key: 'activoNoCorriente.stockActual',               ip: false },
    'socios':                         { key: 'activoNoCorriente.sociosAdelantos',           ip: false },
